...
- **2026-09-11 · feature/ux-polish** — Closed-deal stage/actions locked; overdue shows Closed-with-balance; Deals/Parties empty states; Deal rate required + >0 validation; Monthly Ledger month selector; dynamic modal eyebrows; Trip truck dropdown filtered by transporter; cloud payments hide edit dead-end. **Awaiting owner merge → PR preview.**